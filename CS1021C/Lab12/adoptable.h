...
class Adoptable {
public:
	Adoptable(double weight, bool has_shots, Date adoptable_since, const std::string& first_name,
		const std::string& last_name, AdoptableType type) : weight(weight), has_shots(has_shots),
		adoptable_since(adoptable_since), first_name(first_name), last_name(last_name), type(type) {};
...
public:
	Turtle(double weight, bool has_shots, Date adoptable_since,
...
public:
	Dog(double weight, bool has_shots, Date adoptable_since,
		const std::string& first_name, const std::string& last_name) :
...
public:
	Cat(double weight, bool has_shots, Date adoptable_since,
		const std::string& first_name, const std::string& last_name) :
